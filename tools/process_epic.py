...
def main():
    ...
    parser.add_argument("--root_dir", required=True, help="Directory containing episode folders like 000000, 000001, etc.")
    parser.add_argument("--prefix", required=True, help="New prefix to apply before 'frames'")
