...
@dataclasses.dataclass
class PolicyConfig:
    # fine-tunng stage is 10, for points, it is num of points
    proprio_dim: int= 10
    # proprio_dim: int = 3888

    # fine-tunng stage is 11, for points, it is num of points * 2
    action_dim: int = 11
    # action_dim: int = 3889
    ...
    # Task
    task: Literal["robotics", "3dpoints"] = "robotics"
...
@dataclasses.dataclass
class SharedConfig:
    use_points_mask: bool = False

    num_points: int = 36 * 36
    ...
    resume : Optional[str] = None#'/scratch/partial_datasets/niudt/project/llarva_3dp/ckpts_pretrain/kinova_automated_threetasks_alldemos/checkpoint-21.pth'
