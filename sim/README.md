...
conda create --name lvm-sim python=3.8.1
source lvm-sim
...
LVM-SIM uses the [YARR fork](git@github.com:Dantong88/YARR.git).

```bash
cd <install_dir>
git clone -b lvm-sim git@github.com:Dantong88/YARR.git # note: 'lvm-sim' branch
...
```bash
cd <install_dir>
git clone git@github.com:Dantong88/LVM-SIM.git
```
