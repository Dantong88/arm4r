...
class PreprocessAgent(Agent):
    ...
    def act(self, eps_index: int, step: int, observation: dict,
        ...
        act_res = self._pose_agent.act(eps_index, step, observation, deterministic)
    ...
    def reset(self, language_goal, eps_index) -> None:
        self._pose_agent.reset(language_goal, eps_index = eps_index)
